...
Usage Examples:
    python wv-archive.py -c fromis9 --debug
    python wv-archive.py -c stayc -a all --profile
    python wv-archive.py -c RedVelvet -a IRENE SEULGI --moments
    python wv-archive.py -c fromis9 --live 4-12345678
    python wv-archive.py -c fromis9 -a "LEE SEO YEON" --artist --type photo
    python wv-archive.py -c fromis9 --skip-membership --official 58afde0dbc1fccd94cd44eff91fa3673
    python wv-archive.py -c fromis9 --media 4-223153860
    python wv-archive.py -c APINK --media-menu
    python wv-archive.py -c LESSERAFIM -a Chaewon --artist --text-only --comments --skip-public
